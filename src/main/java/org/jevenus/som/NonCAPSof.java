...
public class NonCAPSof extends Slof {
  ...
  public Map<String, List<Double>> getNonCapVal() {
    ...
    for (String cntyidfp : attrsValMap.keySet()) {
      ...
      capValList.add(white);
      capValList.add(baa);
      capValList.add(aian);
      capValList.add(asian);
      // capValList.add(ai);
      // capValList.add(chinese);
      // capValList.add(filipino);
      // capValList.add(japanese);
      // capValList.add(korean);
      // capValList.add(vietnamese);
      // capValList.add(otherAsian);
      capValList.add(nhopi);
      capValList.add(sor);
  ...
  public List<Double> getMaxCapValList() {
    Map<String, List<Double>> capValMap = getNonCapVal();
  ...
  public static void main(String[] args) {
    NonCAPSof noncapsof = new NonCAPSof();
    ...
    // }
    noncapsof.runAlgo(noncapsof.getSlof());
  }
}
